<template>
  ...
  <div class="container-fluid mb-5 mt-5">
    <div class="row">
      <div class="col-md-12">
        <Link href="/admin/exams" class="btn btn-md btn-primary border-0 shadow mb-3" type="button"
        ...
        <div class="card border-0 shadow">
          <div class="card-body">
            ...
            <form @submit.prevent="submit">
              ...
              <hr />
              <h6><i class="fa fa-shield-alt"></i> Pengaturan Keamanan (Lockdown)</h6>

              <div class="row">
                <div class="col-md-4">
                  <div class="mb-4">
                    <label>Aktifkan Lockdown</label>
                    <select class="form-select" v-model="form.enable_lockdown">
                      <option value="Y">Ya</option>
                      <option value="N">Tidak</option>
                    </select>
                    <small class="text-muted">Kunci layar saat siswa berpindah tab</small>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="mb-4">
                    <label>Durasi Lockdown (Detik)</label>
                    <input
                      type="number"
                      min="5"
                      max="300"
                      class="form-control"
                      v-model="form.lockdown_duration"
                      :disabled="form.enable_lockdown === 'N'"
                    />
                    <small class="text-muted">Lama kunci layar saat pelanggaran</small>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="mb-4">
                    ...
                    <input
                      ...
                      max="10"
                      class="form-control"
                      v-model="form.max_violations"
                      :disabled="form.enable_lockdown === 'N'"
                    />
                    <small class="text-muted">Ujian diakhiri setelah X pelanggaran</small>
                  </div>
                </div>
              </div>
...
export default {
  ...
  setup(props) {
    ...
    const form = reactive({
      ...
      enable_lockdown: props.exam.enable_lockdown || 'Y',
      lockdown_duration: props.exam.lockdown_duration || 30,
      max_violations: props.exam.max_violations || 3,
    });
    ...
    const submit = () => {
      ...
      router.put(
        `/admin/exams/${props.exam.id}`,
        {
          ...
          enable_lockdown: form.enable_lockdown,
          lockdown_duration: form.lockdown_duration,
