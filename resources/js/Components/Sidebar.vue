    ...
    <div class="sidebar-inner px-4 pt-3">
      ...
      <ul class="nav flex-column pt-3 pt-md-0">
            ...
            <span>
              <span class="sidebar-icon">
                <svg
                  ...
                  height="20"
                  fill="currentColor"
                  class="bi bi-mortarboard-fill icon icon-xs me-2"
                  viewBox="0 0 16 16"
                >
                  <path
        ...
        <li
          class="nav-item"
          :class="{
            active: $page.url.startsWith('/admin/exam-violations'),
          }"
        >
          <Link href="/admin/exam-violations" class="nav-link d-flex justify-content-between">
            <span>
              <span class="sidebar-icon">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  ...
                  height="18"
                  fill="currentColor"
                  class="bi bi-exclamation-triangle icon icon-xs me-2"
                  viewBox="0 0 16 16"
                >
                  <path
        ...
        <li
          class="nav-item"
          :class="{
            active: $page.url.startsWith('/admin/grades-by-lesson'),
          }"
        >
          <Link href="/admin/grades-by-lesson" class="nav-link d-flex justify-content-between">
            <span>
              <span class="sidebar-icon">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  ...
                  height="18"
                  fill="currentColor"
                  class="bi bi-book-half icon icon-xs me-2"
                  viewBox="0 0 16 16"
                >
                  <path
              ...
              <span class="sidebar-text">Nilai per Mapel</span>
            </span>
          </Link>
        </li>
      </ul>
        ...
        navLinks?.forEach((link) => {
          link.addEventListener('click', () => {
            ...
            if (window.innerWidth < 992) {
              // Use Bootstrap 5 Collapse API to properly close sidebar
              const bsCollapse = window.bootstrap?.Collapse?.getInstance(sidebar);
              if (bsCollapse) {
                bsCollapse.hide();
              } else if (sidebar.classList.contains('show')) {
                // Fallback: manually toggle classes and remove backdrop
