...
Route::prefix('admin')->group(function () {
    ...
    Route::group(['middleware' => ['auth']], function () {
        ...
        Route::get('/exam-violations', [\App\Http\Controllers\Admin\ExamViolationController::class, 'index'])->name('admin.exam_violations.index');
        Route::get('/exam-violations/{exam_violation}', [\App\Http\Controllers\Admin\ExamViolationController::class, 'show'])->name('admin.exam_violations.show');
        Route::post('/exam-violations/{exam_violation}/forgive', [\App\Http\Controllers\Admin\ExamViolationController::class, 'forgive'])->name('admin.exam_violations.forgive');
        Route::delete('/exam-violations/{exam_violation}', [\App\Http\Controllers\Admin\ExamViolationController::class, 'destroy'])->name('admin.exam_violations.destroy');
    });
});
...
Route::prefix('student')->group(function () {
    ...
    Route::group(['middleware' => 'student'], function () {
        ...
        // route log violation
        Route::post('/exam-violation', [App\Http\Controllers\Student\ExamController::class, 'logViolation'])->name('student.exams.logViolation');

        // route check violation status
        Route::post('/exam-violation/check', [App\Http\Controllers\Student\ExamController::class, 'checkViolationStatus'])->name('student.exams.checkViolationStatus');
    });
});
